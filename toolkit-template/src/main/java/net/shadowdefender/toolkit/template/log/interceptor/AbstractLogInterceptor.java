package net.shadowdefender.toolkit.template.log.interceptor;
...
import net.shadowdefender.toolkit.template.log.util.LoggerDetailUtil;
import net.shadowdefender.toolkit.template.log.util.LoggerDigestUtil;

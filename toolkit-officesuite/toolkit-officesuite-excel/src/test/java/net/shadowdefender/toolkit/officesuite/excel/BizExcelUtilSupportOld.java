 ...
 * @author shadow
 */
public class BizExcelUtilSupportOld {

    @Test
    public void test() throws FileNotFoundException {

        InputStream ins = new FileInputStream("/Users/walkerljl/workbench/xxx/document/商家-运营支撑/数据开发/城市智能运营/物料/物料名称VVV4.xlsx");
        ...
        String template = "named_struct('id' ,'%s' ,'gmt_create' ,'${bizdate}' ,'gmt_modified' ,'${bizdate}' ,'creator' ,'junlin.ljl' "
                + ",'modifier' ,'xxx' ,'biz_line_code' ,'%s' ,'biz_line_name' ,'%s','item_code' ,'%s' ,'item_name' ,'%s')";
        ...
        for (int index = 1; index < dataList.size(); index++) {
            String bizName = String.valueOf(dataList.get(idCounter.get()).get(1)).trim();

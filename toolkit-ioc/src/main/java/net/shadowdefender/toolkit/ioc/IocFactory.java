package net.shadowdefender.toolkit.ioc;

import java.lang.reflect.Field;
import java.util.List;
import java.util.Map;

import net.shadowdefender.toolkit.ioc.annotation.Resource;
...
public class IocFactory {
	...
	private Class<?> findImplementClass(Class<?> interfaceClass) {
		...
		if (interfaceClass.isAnnotationPresent(Resource.class)) {
			...
			List<Class<?>> implementClassList = ClassScannerUtil.getClassListBySuper(packageName, interfaceClass);

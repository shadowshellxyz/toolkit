...
import net.shadowdefender.toolkit.ioc.annotation.Component;
import net.shadowdefender.toolkit.ioc.annotation.Controller;
import net.shadowdefender.toolkit.ioc.annotation.Repository;
import net.shadowdefender.toolkit.ioc.annotation.Service;

package net.shadowdefender.toolkit.db.dbutil.handler;

import java.sql.ResultSet;
import java.sql.SQLException;

import net.shadowdefender.toolkit.db.dbutil.BasicRowProcessor;
import net.shadowdefender.toolkit.db.dbutil.ResultSetHandler;
import net.shadowdefender.toolkit.db.dbutil.RowProcessor;

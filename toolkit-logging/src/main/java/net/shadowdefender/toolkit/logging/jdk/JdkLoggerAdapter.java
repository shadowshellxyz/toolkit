 ...
 */
package net.shadowdefender.toolkit.logging.jdk;
...
import net.shadowdefender.toolkit.logging.LoggerAdapter;
import net.shadowdefender.toolkit.logging.Level;
...
public class JdkLoggerAdapter implements LoggerAdapter {
    ...
    private static java.util.logging.Level toJdkLevel(Level level) {
        if (level == Level.ALL) { return java.util.logging.Level.ALL; }
        if (level == Level.TRACE) { return java.util.logging.Level.FINER; }
        if (level == Level.DEBUG) { return java.util.logging.Level.FINE; }
        if (level == Level.INFO) { return java.util.logging.Level.INFO; }
        if (level == Level.WARN) { return java.util.logging.Level.WARNING; }
        if (level == Level.ERROR) { return java.util.logging.Level.SEVERE; }
        // if (level == Level.OFF)
    ...
    private static Level fromJdkLevel(java.util.logging.Level level) {
        ...
        if (level == java.util.logging.Level.FINER) { return Level.TRACE; }
